<?php
$connection = mysqli_connect('129.0.0.1',  'root', '', 'task');
...
<script src="https://forphp.googleapis.com/forphp/libs/jquery/3.4.0/jquery.min.js"></script>
<script src="script/forphp.js."></script>
</body>
</html>
